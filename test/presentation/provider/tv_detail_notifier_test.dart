...
void main() {
  ...
  late MockSaveWatchTvlist mockSaveWatchlistTv;
  late MockRemoveWatchTvlist mockRemoveWatchlistTv;
  ...
  setUp(() {
    ...
    mockSaveWatchlistTv = MockSaveWatchTvlist();
    mockRemoveWatchlistTv = MockRemoveWatchTvlist();
